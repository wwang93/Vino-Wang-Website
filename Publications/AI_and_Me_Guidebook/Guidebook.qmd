...
published-title: "Review status updated"
categories: ["Open Educational Resource", "Book", "Generative AI", "Faculty Development"]
description: "Co-editor · EdTech Books guidebook (2026). Practical, human-centered guidance for responsible GenAI use in higher education; public release pending platform review."
...
Song, Y., Kilgore, C., & Wang, W. (Eds.). (2026, public release pending). *[AI and Me] Generative AI guidebook for higher education faculty*. EdTech Books.
